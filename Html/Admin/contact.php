...
<body>
        ...
        <div id="Services" class="Services-box">
                <h2 style="font-size: 35px;margin-bottom:2%; color: #ffffff;text-align: center" class="vc_custom">Contact Message</h2>
                </div>
                ...
                if ($result-> num_rows > 0) {
                   // output data of each row
                    while($row = $result->fetch_assoc()) {
                        echo "<tr><td>" . $row["Sr"]. "</td><td>" . $row["name"]. "</td><td>" . $row["email"]. "</td><td>". $row["subject"]. "</td><td>" . $row["phone"]. "</td><td>" . $row["message"]. "</td></tr>" ;
                    }
                    echo "</table>";
                } else {
                    echo "0 results";
